...
**We can get a sense of historical language patterns across Canada by examining broadcasting language data for traditional radio and television channels.**
...
## Research Questions
### **1:** What are the differences in English and French language radio and television consumption patterns across Canada per year (2019-2025)? Geographically, which languages dominate and where?

### **2:**  Over time how have broadcasting hours for traditional media changed in response to new audiovisual platforms and services?
...
```
## Methods
Notebooks [cleaning.ipynb]() and [visualizations.ipynb]() were utilized to help answer the research questions.
...
Despite the presence of new audiovisual platforms and services, the data is not showing dramatic shifts in language preferences for each market from year to year. While English media is experiencing a decline in total broadcast hours, French media remains the most stable.
...
[Canadian Media Consumption Hours Over Time: Trend Line Chart]()
